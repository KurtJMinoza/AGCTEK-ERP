...
/**
 * Maintenance demand — reads synced rows in mm_planning_demands for MAINTENANCE module.
 * External maintenance systems push demand via MM integration API; MM does not own work orders.
 */
@Injectable()
export class MaintenanceDemandProvider implements MmDemandProvider {
    readonly moduleId = MM_DEMAND_MODULES.MAINTENANCE
